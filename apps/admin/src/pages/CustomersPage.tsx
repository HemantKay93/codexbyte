    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-body-sm text-on-surface-variant mt-1">Manage customer profiles and history</p>
        </div>
              ...
              {isLoading ? (
                <TableRow>
                  <TableCell colSpan={7} className="text-center py-12">
                    ...
                    <span className="text-sm text-on-surface-variant mt-2 block">Loading customers...</span>
                  </TableCell>
                </TableRow>
                ...
                <TableRow key={customer.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <a href={`/customers/${customer.id}`} className="font-medium text-on-surface hover:text-primary hover:underline transition-colors">
                          {customer.full_name}
                        </a>
                        <div className="text-[10px] text-on-surface-variant font-mono">{customer.id.substring(0, 8)}...</div>
                      </div>
                    </div>
                  </TableCell>
                  <TableCell>
