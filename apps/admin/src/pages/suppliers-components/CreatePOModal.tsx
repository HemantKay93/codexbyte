        ...
        <div className="p-6 space-y-4 max-h-[60vh] overflow-y-auto">
          ...
          <div className="space-y-4 mt-6">
            ...
            {items.map((item, index) => (
              <div key={index} className="flex items-end gap-3 p-4 bg-surface-container-lowest border border-outline-variant rounded-xl">
                ...
                <div className="w-32">
                  <Input
                    ...
                    onChange={(e) => handleChangeItem(index, 'unitCost', parseFloat(e.target.value) || 0)}
                  />
                </div>
                <Button variant="ghost" className="text-error mb-1 p-2 h-10 w-10" onClick={() => handleRemoveItem(index)}>
