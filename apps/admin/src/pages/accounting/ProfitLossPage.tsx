  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto h-[calc(100vh-8rem)]">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-display-sm font-semibold text-on-background">Profit & Loss Statement</h1>
      ...
      <Card className="p-8">
        <div className="text-center mb-8">
          <h2 className="text-xl font-bold text-on-surface uppercase tracking-widest">ByteEvolvr Technologies</h2>
          <h3 className="text-lg font-semibold text-on-surface-variant mt-1">Profit & Loss Statement</h3>
          <p className="text-sm text-on-surface-variant mt-1">For the period: 1 April 2026 to 31 March 2027</p>
        </div>
