  ...
  return (
    <div className="space-y-6 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="hover:border-primary cursor-pointer transition-colors" onClick={() => navigate('/marketing/campaigns')}>
        ...
        <Card className="hover:border-primary cursor-pointer transition-colors" onClick={() => navigate('/marketing/segments')}>
          <CardContent className="p-6 text-center">
        ...
        <Card className="hover:border-primary cursor-pointer transition-colors" onClick={() => navigate('/marketing/automations')}>
          <CardContent className="p-6 text-center">
        ...
        <Card className="hover:border-primary cursor-pointer transition-colors" onClick={() => navigate('/marketing/templates')}>
          <CardContent className="p-6 text-center">
