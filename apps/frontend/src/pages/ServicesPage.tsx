  ...
  return (
    <>
      ...
      >
        ...
        >
          We provide a comprehensive range of technology services designed to keep your business
          running smoothly, from high-level consulting to ground-level hardware support.
        </motion.p>
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {service.tags.map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full border border-accent/20 bg-primary/10 px-2.5 py-1 font-mono text-[10px] text-accent"
                  >
                    {tag}
                  </span>
                ))}
