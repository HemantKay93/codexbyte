    ...
    <>
      ...
      >
        ...
        <div className="prose prose-invert max-w-none text-brand-muted space-y-6">
          ...
          <p>
            Permission is granted to temporarily download one copy of the materials on ByteeVolvr's
            website for personal, non-commercial transitory viewing only.
          </p>
          <h2 className="text-white text-xl font-bold mt-8">2. Disclaimer</h2>
          <p>
            The materials on ByteeVolvr's website are provided on an 'as is' basis. ByteeVolvr makes
            no warranties, expressed or implied.
          </p>
          <h2 className="text-white text-xl font-bold mt-8">3. Limitations</h2>
          <p>
            In no event shall ByteeVolvr or its suppliers be liable for any damages arising out of
            the use or inability to use the materials on ByteeVolvr's website.
          </p>
        </div>
      </motion.section>
    </>
