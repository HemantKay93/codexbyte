...
export function AboutPage() {
  ...
  return (
    <>
      ...
      >
        <motion.span variants={itemVariants} className="mb-4 block font-mono text-xs uppercase tracking-widest text-accent">// Our Story</motion.span>
        <motion.h1 variants={itemVariants} className="mb-10 max-w-4xl font-display text-5xl font-bold leading-tight text-white lg:text-6xl">
          Empowering Business with <span className="text-primary-light">Intelligent Technology</span> Solutions.
        </motion.h1>
        
        <div className="grid gap-12 lg:grid-cols-2">
          <motion.div variants={itemVariants} className="space-y-6">
            <p className="text-lg leading-relaxed text-brand-muted">
              Founded on the principles of trust and technical excellence, ByteeVolvr Enterprises has evolved from a specialized repair service into a comprehensive IT partner for businesses across India.
            </p>
            <p className="text-lg leading-relaxed text-brand-muted">
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4">
            <div className="glass-panel rounded-2xl p-6">
              ...
              <p className="text-xs text-brand-muted">To provide scalable IT solutions that drive growth.</p>
            </div>
            <div className="glass-panel rounded-2xl p-6">
              <Users className="h-6 w-6 text-accent mb-4" />
              <h3 className="text-white font-bold mb-2">Expert Team</h3>
              <p className="text-xs text-brand-muted">Certified professionals with years of experience.</p>
            </div>
            <div className="glass-panel rounded-2xl p-6">
              <Shield className="h-6 w-6 text-accent mb-4" />
              <h3 className="text-white font-bold mb-2">Total Security</h3>
              <p className="text-xs text-brand-muted">Protecting your data and infrastructure 24/7.</p>
            </div>
            <div className="glass-panel rounded-2xl p-6">
