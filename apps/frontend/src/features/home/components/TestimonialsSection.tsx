const testimonials = [
  {
    quote: "ByteeVolvr handles our office IT infrastructure and cut downtime dramatically after signing our AMC.",
    name: 'Rajesh Mehta',
    title: 'Operations Director',
  },
  {
    quote: "Pricing is competitive, supply is reliable, and the quality is consistently genuine across bulk orders.",
    name: 'Priya Nair',
    title: 'Procurement Manager',
  },
  {
    quote: "Their consulting team gave us a practical roadmap and stayed involved through execution.",
    name: 'Amit Sharma',
    title: 'CEO',
  },
];
    ...
    <section className="relative overflow-hidden py-28" style={{ background: '#070D1A' }}>
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-14 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            <span className="mb-3 block font-mono text-xs uppercase tracking-widest text-accent">// Client Feedback</span>
