  ...
  if (items.length === 0) {
    return (
      <div className="min-h-[70vh] bg-[#04080F] flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-brand-muted mb-8 max-w-md">Looks like you haven't added anything to your cart yet. Discover our premium tech gear to get started.</p>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1">
            <div className="bg-[#070D1A] border border-white/10 rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="divide-y divide-white/5">
                {items.map((item) => (
                  <div key={item.cartItemId} className="p-6 grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                    ...
                    <div className="col-span-1 md:col-span-6 flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-xs text-accent font-semibold uppercase tracking-wide mb-1">{item.brand || item.category}</div>
                        <Link to={`/shop/product/${item.id}`} className="font-bold text-white hover:text-accent transition-colors line-clamp-2 leading-tight">
                          {item.name}
                        </Link>
                        <button 
            ...
            <button onClick={() => navigate('/shop')} className="mt-6 flex items-center gap-2 text-sm text-brand-muted hover:text-white transition-colors">
          ...
          <div className="w-full lg:w-[380px] shrink-0">
            <div className="bg-[#070D1A] border border-white/10 rounded-2xl p-6 shadow-xl sticky top-24">
              ...
              <Button onClick={() => navigate('/shop/checkout')} variant="primary" className="w-full py-4 rounded-xl shadow-[0_0_15px_rgba(26,79,214,0.3)] text-base">
                Proceed to Checkout
              </Button>
              ...
              <div className="mt-6 text-xs text-brand-muted text-center flex flex-col gap-2">
                ...
                <div className="flex justify-center gap-2">
                  ...
                  <div className="px-2 py-1 bg-white/5 rounded border border-white/10">Mastercard</div>
