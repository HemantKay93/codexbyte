  ...
  return (
    <main className="flex-grow pt-12 pb-stitch-section-gap px-stitch-container-padding-mobile md:px-stitch-container-padding-desktop max-w-5xl mx-auto w-full min-h-[calc(100vh-160px)]">
      ...
      <section className="text-center mb-12">
        ...
        >
          <span className="material-symbols-outlined text-stitch-secondary text-5xl" style={{ fontVariationSettings: "'wght' 700" }}>check_circle</span>
        </div>
        <h2 className="font-stitch-display-lg-mobile md:font-stitch-display-lg text-stitch-display-lg-mobile md:text-stitch-display-lg text-stitch-on-surface mb-2 uppercase tracking-tighter">Mission Accomplished</h2>
        ...
        <p className="text-stitch-on-surface-variant max-w-md mx-auto">Systems integrated. Your high-performance hardware is being prepared for extraction. Welcome to the core.</p>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-stitch-gutter">
        ...
        <div className="md:col-span-7 space-y-stitch-gutter">
          <div className="stitch-glass-panel p-8 rounded-xl border border-white/5 bg-stitch-surface-container/20 backdrop-blur-xl">
            <h3 className="font-stitch-headline-lg-mobile text-stitch-headline-lg-mobile text-stitch-primary mb-6 uppercase">Order Manifest</h3>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-center">
                <div className="w-20 h-20 bg-stitch-surface-container rounded-lg overflow-hidden border border-stitch-outline-variant/30 shrink-0">
                  <img className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1611078449942-9aff9c44b958?q=80&w=200&auto=format&fit=crop" alt="Laptop" />
                </div>
                <div className="flex-grow">
                  <div className="font-stitch-headline-lg-mobile text-[18px] text-stitch-on-surface">NEON_LAPTOP X-15</div>
                  <div className="font-stitch-label-sm text-stitch-label-sm text-stitch-on-surface-variant uppercase">RTX 4090 / 64GB RAM / 2TB SSD</div>
                </div>
                <div className="font-stitch-label-sm text-stitch-label-sm text-stitch-secondary">{currencySymbol}3,499.00</div>
              </div>
              
              <div className="flex gap-4 items-center pt-6 border-t border-stitch-outline-variant/20">
                <div className="w-20 h-20 bg-stitch-surface-container rounded-lg overflow-hidden border border-stitch-outline-variant/30 shrink-0">
                  <img className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1595225476474-87563907a212?q=80&w=200&auto=format&fit=crop" alt="Keyboard" />
                </div>
                <div className="flex-grow">
                  <div className="font-stitch-headline-lg-mobile text-[18px] text-stitch-on-surface">CORE_GLOW TKL</div>
                  <div className="font-stitch-label-sm text-stitch-label-sm text-stitch-on-surface-variant uppercase">Mechanical / Optical Switches</div>
                </div>
                <div className="font-stitch-label-sm text-stitch-label-sm text-stitch-secondary">{currencySymbol}189.00</div>
              </div>
            </div>
        ...
        <div className="md:col-span-5 space-y-stitch-gutter">
          ...
          <div className="stitch-glass-panel p-8 rounded-xl border-l-4 border-l-stitch-secondary bg-stitch-surface-container/20 backdrop-blur-xl">
            <div className="font-stitch-label-sm text-stitch-label-sm text-stitch-secondary mb-2 uppercase tracking-widest">Expected Deployment</div>
            <div className="font-stitch-headline-lg-mobile text-stitch-headline-lg text-stitch-on-surface mb-6">OCTOBER 24, 2024</div>
            <div className="space-y-4">
              <div className="flex gap-3">
                <span className="material-symbols-outlined text-stitch-primary">local_shipping</span>
                <div>
                  <div className="font-stitch-label-sm text-stitch-label-sm text-stitch-on-surface uppercase">Extraction Point</div>
                  <p className="text-stitch-on-surface-variant text-sm">2049 Silicon Valley Blvd,<br/>Building 7, Suite 101<br/>San Francisco, CA 94103</p>
                </div>
              </div>
              <div className="flex gap-3 pt-4 border-t border-stitch-outline-variant/20">
                ...
                <div>
                  <div className="font-stitch-label-sm text-stitch-label-sm text-stitch-on-surface uppercase">Transmission Log</div>
