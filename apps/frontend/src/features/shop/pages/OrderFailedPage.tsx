  ...
  return (
    <main className="flex-grow flex items-center justify-center px-stitch-container-padding-mobile pt-12 pb-20 overflow-hidden relative min-h-[calc(100vh-160px)]">
      ...
      <div className="max-w-2xl w-full text-center relative z-10">
        ...
        <div
          className="stitch-glass-panel p-stitch-gutter md:p-12 rounded-xl border-t border-l border-white/5 flex flex-col items-center"
          style={{ boxShadow: '0 0 30px rgba(255, 180, 171, 0.15)' }}
        >
          ...
          <div className="space-y-4 mb-10">
            ...
            <p className="font-stitch-body-md text-stitch-body-md text-stitch-outline-variant max-w-md mx-auto">
              We encountered a critical interruption during your transaction. Your payment could not
