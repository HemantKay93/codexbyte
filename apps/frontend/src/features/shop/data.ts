export const shopProducts = [
  ...
  },
  {
    ...
    description:
      'Fast, secure monochrome laser printer designed to let you focus on growing your business.',
    price: 28500,
    originalPrice: 32000,
    category: 'Printers',
    brand: 'HP',
    ...
    items: [
      {
        name: 'Monitors',
        image:
          'https://images.unsplash.com/photo-1527443154391-507e9dc6c5cc?auto=format&fit=crop&q=80&w=300',
      },
      {
        name: 'Keyboards',
        image:
          'https://images.unsplash.com/photo-1595225476474-87563907a212?auto=format&fit=crop&q=80&w=300',
      },
      {
        name: 'Mice',
        image:
      ...
      },
      {
        name: 'Chairs',
        image:
          'https://images.unsplash.com/photo-1505843490538-5133c6c7d0e1?auto=format&fit=crop&q=80&w=300',
      },
    ],
    linkText: 'See more',
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: 'External HDDs',
        image:
          'https://images.unsplash.com/photo-1597848212624-a19eb35e2651?auto=format&fit=crop&q=80&w=300',
      },
      {
        name: 'SSDs',
        image:
          'https://images.unsplash.com/photo-1531492746076-161ca9bcad58?auto=format&fit=crop&q=80&w=300',
      },
      {
        name: 'Switches',
        image:
          'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?auto=format&fit=crop&q=80&w=300',
      },
    ],
...
export const secondaryOfferCards = [
  {
    ...
    type: 'single',
    image:
      'https://images.unsplash.com/photo-1588693892330-01967e8913b5?auto=format&fit=crop&q=80&w=600',
    ...
    items: [
      {
        name: 'Smart Speakers',
        image:
          'https://images.unsplash.com/photo-1543512214-318c7553f230?auto=format&fit=crop&q=80&w=300',
      },
      {
        name: 'Security Cameras',
        image:
          'https://images.unsplash.com/photo-1557324232-b8917d3c3dcb?auto=format&fit=crop&q=80&w=300',
      },
      {
        name: 'Smart Bulbs',
        image:
          'https://images.unsplash.com/photo-1550989460-0adf9ea622e2?auto=format&fit=crop&q=80&w=300',
      },
      {
        name: 'Smart Plugs',
        image:
          'https://images.unsplash.com/photo-1558089687-f282ffcbc126?auto=format&fit=crop&q=80&w=300',
      },
    ],
  ...
  },
  {
    ...
    type: 'single',
    image:
      'https://images.unsplash.com/photo-1550005973-540ee5b19163?auto=format&fit=crop&q=80&w=600',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        name: 'Speakers',
        image:
          'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?auto=format&fit=crop&q=80&w=300',
      },
      {
        name: 'Soundbars',
        image:
          'https://images.unsplash.com/photo-1545454675-3531b543be5d?auto=format&fit=crop&q=80&w=300',
      },
    ],
...
export const categories = [
  ...
  },
  {
    name: 'Printers',
    image:
      'https://images.unsplash.com/photo-1588693892330-01967e8913b5?auto=format&fit=crop&q=80&w=400',
  },
  {
    name: 'Peripherals',
    image:
