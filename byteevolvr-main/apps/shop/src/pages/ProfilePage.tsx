                ...
                <div key={addr.id} style={{ padding: 20, borderRadius: 16, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.01)', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    <button 
                      ...
                      style={{ pading: 8, borderRadius: 8, border: 'none', background: 'rgba(255,255,255,0.05)', color: '#fff', cursor: 'pointer' }}
                    ><Edit2 size={16} /></button>
                    <button 
                      onClick={() => handleDeleteAddress(addr.id)}
                      style={{ pading: 8, borderRadius: 8, border: 'none', background: 'rgba(255,75,75,0.1)', color: '#ff4b4b', cursor: 'pointer' }}
