      ...
      rightElement={
        <div className="flex flex-col lg:flex-row lg:items-center gap-4">
          <div className="flex flex-col lg:flex-row lg:items-center gap-3 text-xs font-medium lg:border-r border-white/10 lg:pr-5">
            <a href="mailto:support@byteevolvr.com" className="group flex items-center gap-2 hover:text-white transition-all py-1.5 lg:py-1 px-3 rounded-full bg-white/[0.02] hover:bg-white/[0.06] border border-white/[0.05] hover:border-white/10 text-brand-muted">
            ...
            <a href="tel:+919876500000" className="group flex items-center gap-2 hover:text-white transition-all py-1.5 lg:py-1 px-3 rounded-full bg-white/[0.02] hover:bg-white/[0.06] border border-white/[0.05] hover:border-white/10 text-brand-muted">
              <div className="p-1 rounded-full bg-accent/10 group-hover:bg-accent/20 transition-colors shrink-0">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-2 lg:border-l border-white/10 lg:pl-5 pt-3 lg:pt-0 border-t lg:border-t-0">
            <Link to="/shop" className="relative group px-3 py-1.5 rounded-full overflow-hidden text-xs font-semibold text-white">
              ...
              <span className="relative z-10 group-hover:text-accent transition-colors duration-300">Shop</span>
            </Link>
            
            {isShopRoute && (
              <>
                {user ? (
                  <Link to="/shop/dashboard" className="group flex items-center justify-center h-8 w-8 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-accent/50 transition-all duration-300 text-white hover:text-accent" title="Dashboard">
                    <User className="h-3.5 w-3.5 group-hover:scale-110 transition-transform duration-300" />
                  </Link>
                ) : (
                  <Link to="/shop/login" className="group flex items-center justify-center h-8 w-8 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-accent/50 transition-all duration-300 text-white hover:text-accent" title="Sign In">
                    <User className="h-3.5 w-3.5 group-hover:scale-110 transition-transform duration-300" />
                  </Link>
                )}
      ...
      mobileRightElement={
        isShopRoute ? (
          <div className="flex items-center gap-3">
            {user ? (
              <Link to="/shop/dashboard" className="text-white hover:text-accent transition-colors" title="Dashboard">
                <User className="h-4 w-4" />
              </Link>
            ) : (
              <Link to="/shop/login" className="text-white hover:text-accent transition-colors" title="Sign In">
                <User className="h-4 w-4" />
              </Link>
            )}
