...
export function Footer({ logo, description, sections, copyright, LinkComponent }: FooterProps) {
  const socialIcons = [
    { icon: Facebook, href: '#' },
    { icon: Twitter, href: '#' },
    { icon: Instagram, href: '#' },
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-4">
            ...
            <p className="mb-8 text-sm leading-relaxed text-brand-muted max-w-sm">
              {description}
            </p>
        ...
        <div className="mt-10 border-t border-white/5 pt-6 flex flex-col md:flex-row justify-between gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-xs text-brand-subtle hover:text-white transition-colors">Privacy Policy</a>
            <a href="#" className="text-xs text-brand-subtle hover:text-white transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
