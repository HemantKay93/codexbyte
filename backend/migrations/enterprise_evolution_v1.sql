...
-- Basic Default Seeds for CRM (Assuming we can insert directly if tables are empty or relying on code init)
-- We'll leave seeding to the backend init script if needed, or we can write a simple default insertion script later.
