...
// System Health
router.get('/health/integrations', adminController.getIntegrationHealth);
...
router.post('/warehouse/transfer-stock', warehouseController.transferStock);
router.post('/warehouse/tasks/pick', warehouseController.markTaskPicked);
