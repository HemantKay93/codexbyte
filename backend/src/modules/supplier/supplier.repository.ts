...
export class SupplierRepository {
  ...
  async createSupplier(supplierData: any) {
    ...
    if (supplierData.contact_name !== undefined) safePayload.contact_name = supplierData.contact_name;
    if (supplierData.email !== undefined && supplierData.email !== '') safePayload.email = supplierData.email;
