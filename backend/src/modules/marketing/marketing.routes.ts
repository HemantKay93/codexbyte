...
import { createCouponSchema, validateCouponSchema, createCampaignSchema } from './marketing.validator.js';

const router = express.Router();

// Public / Customer routes
router.post('/validate-coupon', authenticate, validate(validateCouponSchema), marketingController.validateCoupon);
